...
!function(t) {
    ...
    function e(i, s) {
        this.$element = t(i),
        this.options = t.extend({}, e.DEFAULTS, t.isPlainObject(s) && s),
        this.placeholders = t.extend({}, e.DEFAULTS),
        this.active = !1,
        this.init()
    }
    ...
    e.prototype = {
        ...
        init: function() {
            ...
            t.each([c, o, r], t.proxy(function(t, c) {
                n[c] ? (i[c] = n[c],
                this["$" + c] = e.filter("[data-" + c + "]")) : this["$" + c] = s > t ? e.eq(t) : null
            }, this)),
            this.bind(),
            this.reset(),
            this.active = !0
        ...
        output: function(e) {
            ...
            a && a.length && (h = d[e],
            s = e === c ? 86 : e === o ? this.$province && this.$province.find(":selected").data("code") : e === r ? this.$city && this.$city.find(":selected").data("code") : s,
            f = t.isNumeric(s) ? i[s] : null,
            t.isPlainObject(f) && t.each(f, function(t, i) {
                var e = i === h;
                e && (n = !0),
                p.push({
                    code: t,
            ...
            n || (p.length && (d.autoSelect || d.autoselect) && (p[0].selected = !0),
            !this.active && h && (u[e] = h)),
            d.placeholder && p.unshift({
                code: "",
                address: u[e],
                selected: !1
            }),
        ...
        reset: function(t) {
            t ? this.$province && this.$province.find(":first").prop("selected", !0).trigger(n) : (this.output(c),
            this.output(o),
            this.output(r))
        },
        destroy: function() {
    ...
    ,
    e.other = t.fn.distpicker,
    t.fn.distpicker = function(i) {
        ...
        return this.each(function() {
            ...
            if (!h) {
                if (/destroy/.test(i))
                    return;
                c = t.extend({}, r.data(), t.isPlainObject(i) && i),
                r.data(s, h = new e(this,c))
            }
            "string" == typeof i && t.isFunction(o = h[i]) && o.apply(h, n)
        })
    }
    ,
    t.fn.distpicker.Constructor = e,
    t.fn.distpicker.setDefaults = e.setDefaults,
    t.fn.distpicker.noConflict = function() {
        return t.fn.distpicker = e.other,
        this
    }
    ,
    t(function() {
