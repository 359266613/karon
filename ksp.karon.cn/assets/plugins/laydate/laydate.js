...
;!function() {
    ...
    var e = window.layui && layui.define
      ...
      , n = {
        ...
        set: function(e) {
            var n = this;
            return n.config = t.extend({}, n.config, e),
            n
        },
        ready: function(a) {
            var i = "laydate"
      ...
      , D = function(e) {
        var t = this;
        t.index = ++n.index,
        t.config = T.extend({}, t.config, n.config, e),
        n.ready(function() {
            t.init()
        })
    }
    ...
    D.prototype.init = function() {
        ...
        e.EXP_SPLIT = new RegExp(e.EXP_SPLIT,"g"),
        ...
        t.mark = T.extend({}, t.calendar && "cn" === t.lang ? {
            "0-1-1": "元旦",
            "0-2-14": "情人",
            "0-3-8": "妇女",
            "0-3-12": "植树",
    ...
    D.prototype.render = function() {
        ...
        /^#/.test(t.theme)) {
            ...
            "styleSheet"in c ? (c.setAttribute("type", "text/css"),
            c.styleSheet.cssText = m) : c.innerHTML = m,
        ...
        e.changeEvent(),
        D.thisElem = e.elemID,
        "function" == typeof t.ready && t.ready(T.extend({}, t.dateTime, {
    ...
    D.prototype.checkDate = function(e) {
        ...
        r.dateTime = T.extend({}, i.startDate),
        T.each([i.startDate, i.endDate], function(e, t) {
            m(t, l[e], e)
    ...
    D.prototype.calendar = function(e) {
        ...
        r.firstDate || (r.firstDate = T.extend({}, l)),
        c.setFullYear(l.year, l.month, 1),
        t = c.getDay(),
        a = n.getEndDate(l.month, l.year),
        i = n.getEndDate(l.month + 1, l.year),
        T.each(y, function(e, n) {
        ...
        T(f[0]).attr("lay-ym", l.year + "-" + (l.month + 1)),
        T(f[1]).attr("lay-ym", l.year + "-" + (l.month + 1)),
        "cn" === s.lang ? (T(f[0]).attr("lay-type", "year").html(l.year + "年"),
        T(f[1]).attr("lay-type", "month").html(l.month + 1 + "月")) : (T(f[0]).attr("lay-type", "month").html(m.month[l.month]),
        T(f[1]).attr("lay-type", "year").html(l.year)),
        ...
        "time" === s.type ? r.setBtnStatus("时间", T.extend({}, r.systemDate(), r.startTime), T.extend({}, r.systemDate(), r.endTime)) : r.setBtnStatus(!0))),
    ...
    D.prototype.list = function(e, t) {
        ...
        "year" === e) {
            var M, b = M = w[0] - 7;
            b < 1 && (b = M = 1),
            T.each(new Array(15), function(e) {
                var a = T.elem("li", {
                    "lay-ym": M
                });
                M == w[0] && T(a).addClass(o),
                a.innerHTML = M + D,
                d.appendChild(a),
                n.limit(T(a), {
                    year: M
            ...
            T.each(new Array(12), function(e) {
                var a = T.elem("li", {
                    "lay-ym": e
                });
                e + 1 == w[1] && T(a).addClass(o),
                a.innerHTML = r.month[e] + (f ? "月" : ""),
                d.appendChild(a),
                n.limit(T(a), {
                    year: w[0],
                    month: e
            ...
            var E = function() {
                ...
                a.range || n.limit(T(n.footer).find(p), n[x], 0, ["hours", "minutes", "seconds"])
            };
            a.range ? n[x] || (n[x] = {
                hours: 0,
                minutes: 0,
            ...
            T.each([24, 60, 60], function(e, t) {
                var a = T.elem("li")
                  , i = ["<p>" + r.time[e] + "</p><ol>"];
                T.each(new Array(t), function(t) {
                    i.push("<li" + (n[x][C[e]] === t ? ' class="' + o + '"' : "") + ">" + T.digit(t, 2) + "</li>")
                }),
        ...
        h.appendChild(d),
        "year" === e || "month" === e)
            T(n.elemMain[t]).addClass("laydate-ym-show"),
            T(d).find("li").on("click", function() {
                ...
                if (!T(this).hasClass(s)) {
                    ...
                    "year" === a.type || "month" === a.type ? (T(d).find("." + o).removeClass(o),
                    T(this).addClass(o),
            ...
            T(d).find("ol").each(function(e) {
                ...
                T(t).find("li").on("click", function() {
                    ...
                    T(this).hasClass(s) || (a.range ? n[x][C[e]] = r : i[C[e]] = r,
                    T(t).find("." + o).removeClass(o),
                    T(this).addClass(o),
                    n.setBtnStatus(null, T.extend({}, n.systemDate(), n.startTime), T.extend({}, n.systemDate(), n.endTime)),
                    E(),
                    k(),
    ...
    D.prototype.stampRange = function() {
        ...
        if (a.range && !n.endDate && T(n.footer).find(p).addClass(s),
        n.endDate)
            return e = n.newDate({
            ...
            e > t ? n.hint(l) : void T.each(i, function(a, i) {
    ...
    D.prototype.choose = function(e) {
        var t = this
          ...
          , l = function(e) {
            new Date;
            e && T.extend(a, r),
            n.range && (t.startDate ? T.extend(t.startDate, r) : t.startDate = T.extend({}, r, t.startTime),
            t.startYMD = r)
        };
        if (r = {
            year: 0 | r[0],
        ...
        !e.hasClass(s))
            if (n.range) {
                ...
                t.endState)
                    ...
                    if (e.addClass(o),
                    t.endDate ? T.extend(t.endDate, r) : t.endDate = T.extend({}, r, t.endTime),
    ...
    D.prototype.tool = function(e, t) {
        var n = this
          ...
          , o = {
            datetime: function() {
                T(e).hasClass(s) || (n.list("time", 0),
                a.range && n.list("time", 1),
                T(e).attr("lay-type", "date").html(n.lang().dateTips))
            },
            date: function() {
                n.closeList(),
    ...
    D.prototype.change = function(e) {
        var t = this
          ...
          , s = function(s) {
            ...
            t.setBtnStatus(),
            n.range || t.limit(T(t.footer).find(p), {
                year: o[0]
            })),
            d || c
        };
    ...
    D.prototype.changeEvent = function() {
        ...
        T.each(e.elemHeader, function(t, n) {
            ...
            T(n[2]).find("span").on("click", function(n) {
                var a = T(this)
                  , i = a.attr("lay-ym").split("-")
                  , r = a.attr("lay-type");
                e.listYM[t] = [0 | i[0], 0 | i[1]],
                e.list(r, t),
                T(e.footer).find(v).addClass(s)
            }),
    ...
    D.prototype.events = function() {
        ...
        T(document).on("click", function(n) {
            ...
            13 === t.keyCode && T("#" + e.elemID)[0] && e.elemID === D.thisElem && (t.preventDefault(),
            T(e.footer).find(p)[0].click())
        }),
